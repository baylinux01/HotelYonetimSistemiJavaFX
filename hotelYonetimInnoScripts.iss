...
AppId={{076B9218-38F3-4800-A7AE-4AA55CCD34F9}
AppName={#MyAppName}
...
InfoBeforeFile=G:\HotelManagementSystemJavaFX\README.md
InfoAfterFile=G:\HotelManagementSystemJavaFX\README.md
; Remove the following line to run in administrative install mode (install for all users.)
PrivilegesRequired=lowest
PrivilegesRequiredOverridesAllowed=commandline
OutputDir=G:\HotelManagementSystemJavaFX
OutputBaseFilename=hotelYonetimSetup
Compression=lzma
